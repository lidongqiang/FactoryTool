...
//  -----
typedef struct _CT_DISPINFO  {
	NMHDR hdr;
	CTITEM item;
}CT_DISPINFO;

typedef map<HTREEITEM,COLORREF> TREEITEMCOLOR_MAP;
...
public:
	...
	void SetRowBKColor(HTREEITEM hItem,COLORREF color,BOOL bAddFlag=TRUE);
	COLORREF GetRowBKColor(HTREEITEM hItem);
...
protected:
	...
	TREEITEMCOLOR_MAP m_colorMap;
	CCriticalSection m_csColorMap;
	...
	CT_DISPINFO m_dispInfo;
	
	virtual void Initialize();
	void UpdateColumns();
	void RepositionControls();

	virtual void GetCellColors(HTREEITEM hItem, CDC *pDC,BOOL *pChangeFlag);
...
#define CTN_GETDISPINFO			TVN_GETDISPINFO